import type { SpriteStyle } from '../api/types.js';
...
export const DEFAULT_MODEL: 'gemini-2.5-flash-image' | 'gemini-3-pro-image-preview' = 'gemini-2.5-flash-image';

// Default style
export const DEFAULT_STYLE: SpriteStyle = 'fantasy';
