...
(This is not to say that it will *finish* in two weeks if it works.  That would be nuts, we're looking at a few months of dedicated practice here.  No, early stages of this working ought to look like "whipsawing between confidence and nervousness depending on presence or absence of mental Project activity at any point in time, frequently within the same conversation, at varying ratios depending on amount of skill attained."  The zenlike character of it will probably only stick around for a little bit the first time.  This is normal because the rate at which the Project hands you tasks will not have changed, and the Trace-and-Surrender has to be done anew on each task.)
