...
- **Self-Loathing**: I think self-loathing frequently co-occurs with social anxiety because behaviors associated with self-loathing (eg verbal self-flagellation) are ways one might go about preventing others from lashing out at you for perceived wrongdoing; people feel more sympathy for the repentant sinner than the gleefully unrepentant sinner.  Ultimately I think this is a mental compulsion (structurally identical to rumination) that is mostly oriented at disapproval avoidance; it is therefore not best regarded as a literal belief so much as a compulsive instrumental strategy that is eligible for banning. Which ALSO implies (via identical logic as for rumination) that any attempts to figure out whether you are in some abstract way worthy of self-loathing are also compulsions, ultimately in service of the Project, that require banning; you are thus forbidden from trying to come to any conclusion about your worth as a person. Sorry, I don't make the rules.
...
- **Avoiding any form of social claiming.**  Not asking people to make room on a couch, not asking to join conversations.

- **Not accepting favors.**  What if they resent me?  (This represents a ban on social reciprocity from the receiving direction)
...
4. It's *probably* going to be some variant of the mental policies list we discussed above.  Recognize the policy as the Project.  At this point, the Trace is complete.
...
Most therapeutic protocols around OCD are subtractive: "you're doing this bad thing, and we're trying to help you stop doing it."  Which: valid, and that is in fact a lot of what we're trying to do here.  But in this section my goal is to set up a behavioral apparatus that can run forever as replacement behavior. 
...
I think social anxiety is, partly, a philosophical disorder.  (Not gonna find *that* one as a category in the DSM anytime soon.)
...
You don't have to persuade yourself of this statement at any particularly deep level; intellectual acceptance is entirely adequate. From there, you only have to *act* as though this were the case, and you will end up believing it.  Gut-level beliefs are downstream of what your brain observes you doing (see also the James-Lange theory of emotion).

### The Specific Principles I Suggest

I think I have arrived at a set of workable principles that satisfy the above criteria.

You are allowed any social behavior that can be justified on one of three grounds.

#### 1. Vulnerable Honesty

Saying true things about what you think, feel, want, or notice. This includes things that might not land well, things that are awkward, and things that expose you to potentially-negative social judgment. You should gate this with kindness so as to not be an asshole.
...
Also, it's *fun*.  When you say something that most people wouldn't, unapologetically, without hedging, it frequently causes tiny BSODs to ripple across their features.  "I'm giving a talk at a sex festival" said in tones of bland fact feels a little bit like handing someone a live grenade and, now, your reward is to watch in fascination as you watch them frantically compute whether they need to throw it out the window.  Reactions vary!
...
### Isn't this just replacing the Mind-Control Project with another performance?
...
I want it to be sunny tomorrow; this is healthy and normal.  If I spent an enormous amount of cognitive or physical labor on the project of *making* it be sunny out via a complicated series of ritualistic dances, which I spent hours in bed ruminating about every day, then we're getting into court-ordered antipsychotics territory.

Likewise, you can care about social approval all you like!  I too prefer when people like me.  However, I am banned from saying or doing anything whatsoever to bring this about (outside of acting from the three principles discussed above); if I am liked it will be by accident, which is always the case anyway.
...
You are going to think about social interactions after they happen. That's unavoidable, but also therapeutically *extremely* dangerous because the most damaging of the mental compulsions live here.

### Forbidden Cognition

- Trying to figure out how you came off.
- Trying to reconstruct what someone else thought about something you did.
...
Note that we're doing two things: we're both forbidding these outright, but we are also making them *non-action relevant.*  There is no *point* to figuring out how you came off because there are approximately ~0 situations where the principles of (Honesty, Kindness, Selfishness) require you to know how you were perceived at any time. "That thing I said sounded so awkward!"  So?  This fact, if true, was forbidden for you to act on in the past, and cannot inform your future behavior; awkwardness-avoidance is prohibited per policy.  

It's like ruminating about the temperature in Iceland.  Is it 45 degrees in Reykjavik?  I dunno, maybe?
...
Attempting to figure out how to avoid coming off poorly next time is the Project reasserting itself. Do not engage.

### "But What About Legitimate Social Learning?"

If you're reading this document you've been "social learning" for years.  Has that gotten you where you want to go?
...
(NOTE: if you can't get your anxiety about presumptiousness down to 0 then *probably* you shouldn't go up to the group.  We do not do exposures while compulsing because that's just suffering with extra steps.  I mean, I guess you could, it's just not what I consider to be therapeutic.)
...
### I still think someone might be uncomfortable.

People are made low-grade uncomfortable many times per day.  The attempts at compulsively avoiding discomfort for others is, I think, one of the very prosocial impulses that people with anxiety disorders take to an extreme where *literally any possibility of inflicting discomfort on someone else* is absolutely unthinkable.
...
**Middle:** I mostly don't feel anxious (80% resolved, maybe?) but still have a fairly limited repertoire of behaviors since I'm very used to the extremely managed set of things I would say and do.  Occasionally I notice I'm continuing to compulse in small ways out of reflex, and stop doing it.  A few months in, some friends, unsolicited, commented that I seemed different and better.
...
Notice it and refuse.

### But what if I actually *am* being try-hard?
...
The half-assed middle ground I think I've ended up at is "maybe see an OCD or metacognitive therapy specialist who is willing to work on social phobia."  I believe Dr. Michael Greenberg actually does this (or so claims his site at https://drmichaeljgreenberg.com/ ), which is a very funny recommendation to make given that I've never interacted with him in any way but he has written some *banger* articles on this topic that make me respect him as a thinker in this space.
...
A very important question!  A protocol which can never fail, only ever *be* failed, is a bad protocol. 

My hope is you can make such a determination within perhaps four hours total over two weeks; my criteria for "evidence this will work for you personally" is basically "can you make the passive version of the Trace-And-Surrender deliver an immediate and total anxiety drop within a few minutes of exposure to a single stressful social situation"; that's the test.  If you are unable to do so even in a low-grade exposure, then I consider the protocol to have failed you. 

Remember: we're not talking about "slightly less nervous, maybe."  *Zenlike.  Fucking.  Tranquility*.  Perhaps mild curiosity.

(This is not to say that it will *finish* in two weeks if it works.  That would be nuts, we're looking at a few months of dedicated practice here.  No, early stages of this working ought to look like "whipsawing between confidence and nervousness depending on presence or absence of mental Project activity at any point in time, frequently within the same conversation."  The zenlike character of it will probably only stick around for a little bit the first time.    This is normal because the rate at which the Project hands you tasks will not have changed, and the Trace-and-Surrender has to be done anew on each task.)  

If you *are* able to do get this to work at least once, then I think you should stick with it; the difference between "I can run this once" and "I can run this close to instantly in nearly every social situation forever" (which is *actually pretty sweet* if you get there) is basically just one of practice, which means if you can do it once then most of your game is won.

**Before concluding this I'd like you to try a few troubleshooting steps**:

(0) Try it first in the lowest-stakes situations where you still have anxiety, just to establish the general principle.  See the Exposure Ladder previously; don't just jump straight to "white-knuckling through asking out my crush" or whatever.
...
This also ties into my contraindications earlier: if your social environment has a norm that making someone uncomfortable is a serious transgression-- not just clumsy, but potentially evidence of deep character flaws that merits serious social sanction-- then the rational response is to monitor other people's emotional states in real time and adjust your behavior to prevent any negative reactions. Which is literally the Mind Control Project. I think that early-2010s progressive culture was often prescribing *this specific pathology* as correct social behavior and framing people who don't run the Mind-Control Project as morally deficient.  I think this was sufficient to generate the pathology in some number of susceptible people.
...
I find this maddening because when doing research for this I kept seeing pop-science articles claiming that CBT is "evidence-based" for romantic anxiety.  False!  It is evidence-based for *social anxiety* and we *have collectively decided to assume* that it works for romantic anxiety.
...
OCD-spectrum disorders include: contamination OCD, harm OCD, scrupulosity OCD, moral OCD. I'm leaving some out.
